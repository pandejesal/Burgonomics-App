...
exports.authApp = exports.auth = exports.verifyOtp = exports.requestOtp = exports.handleVerifyOtp = exports.handleRequestOtp = exports.normalizeIndianPhone = exports.applyCors = void 0;
 ...
 */
function bridgeFunctionsConfig() {
    try {
        const config = functions.config();
        if (config === null || config === void 0 ? void 0 : config.sms) {
...
async function handleRequestOtp(req, res) {
    ...
    try {
        ...
        let ipCount = (ipData === null || ipData === void 0 ? void 0 : ipData.count) || 0;
        const windowStartAt = (ipData === null || ipData === void 0 ? void 0 : ipData.windowStartAt) || now;
        ...
        if (existingData === null || existingData === void 0 ? void 0 : existingData.lastRequestedAt) {
        ...
        let dailyCount = (existingData === null || existingData === void 0 ? void 0 : existingData.dailyCount) || 0;
        const firstRequestAt = (existingData === null || existingData === void 0 ? void 0 : existingData.firstRequestAt) || now;
        ...
        const hashedCode = (0, smsProvider_1.hashOtp)(code, salt);
        ...
        const isTestMode = process.env.OTP_TEST_MODE === "1" ||
            process.env.SMS_PROVIDER === "test" ||
            (!(0, smsProvider_1.getSMSProvider)() && !process.env.MSG91_API_KEY && !process.env.FAST2SMS_API_KEY && !process.env.TWILIO_ACCOUNT_SID);
        if (isTestMode) {
        ...
        const dispatchResult = await (0, smsProvider_1.sendOtpWithFallback)(normalizedPhone, code, deliveryMethod === "whatsapp" ? "whatsapp" : "sms");
...
exports.handleRequestOtp = handleRequestOtp;
/**
...
async function handleVerifyOtp(req, res) {
    ...
    try {
        ...
        const computedHash = (0, smsProvider_1.hashOtp)(code.trim(), otpData.salt);
        const expectedHash = otpData.hashedCode;
        const isMatch = expectedHash.length === computedHash.length &&
            crypto.timingSafeEqual(Buffer.from(expectedHash, "utf8"), Buffer.from(computedHash, "utf8"));
        if (!isMatch) {
...
exports.requestOtp = functions.https.onRequest(handleRequestOtp);
exports.verifyOtp = functions.https.onRequest(handleVerifyOtp);
